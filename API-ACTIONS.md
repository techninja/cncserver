...
> ## _QUICK NOTE:_
>
> _Any comments visible in responses/JSON payload in the documentation
...
>
> - `"stage"`, `"trace"`, `"fill"`, & `"full"`
>   - If "stage", the project will be placed on the staging layer and can be
>     rendered to draw lines on the preview layer.
