...
{
    "servo:minduration": 450  // Only duration will be set when using nconf collapsed JSON format
}
...
JSON notation to replace sub-level items like `servo:minduration`, or you can
